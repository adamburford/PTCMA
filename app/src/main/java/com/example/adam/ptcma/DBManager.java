...
public class DBManager {
    ...
    public Cursor fetch() {
        String[] columns = new String[] { DatabaseHelper._ID, DatabaseHelper.NAME, DatabaseHelper.PHONE, DatabaseHelper.EMAIL, DatabaseHelper.ADDRESS};
    ...
    public int update(long _id, String name, String phone, String email, String address) {
